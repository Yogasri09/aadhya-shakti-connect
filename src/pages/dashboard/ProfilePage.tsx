...
import { User, MapPin, Sparkles, Save, Loader2, ClipboardList } from "lucide-react";
...
export default function ProfilePage() {
  ...
  const questionnaireLabels: Record<string, string> = {
    primaryGoal: "Primary Goal", interests: "Interests", skillLevel: "Skill Level",
    learningMode: "Learning Mode", needMentorship: "Need Mentorship", mentorshipArea: "Mentorship Area",
    govSchemeInterest: "Govt Scheme Interest", budget: "Budget", weeklyTime: "Weekly Time",
    interestedInSelling: "Interested in Selling", businessType: "Business Type",
    preferLocal: "Prefer Local", motivation: "Motivation", needCertification: "Need Certification",
    language: "Language",
  };
  ...
  return (
    <div className="max-w-2xl mx-auto space-y-6">
      <div>
        ...
        <p className="text-muted-foreground mt-1">Manage your personal information and questionnaire answers.</p>
      </div>
      ...
      <Card>
        ...
        <CardContent className="space-y-5">
          ...
          <div className="space-y-1.5">
            ...
            <Input value={location} onChange={handleChange(setLocation)} placeholder="e.g. Mumbai, Maharashtra" />
          </div>
      ...
      <Card>
        <CardHeader>
          <CardTitle className="flex items-center gap-2 text-lg">
            <ClipboardList className="h-5 w-5 text-primary" /> Questionnaire Answers
          </CardTitle>
              ...
              {Object.entries(questionnaire).map(([key, value]) => {
                ...
                return (
                  <div key={key} className="p-3 rounded-lg bg-muted">
                    <p className="text-xs text-muted-foreground mb-0.5">{questionnaireLabels[key] || key}</p>
